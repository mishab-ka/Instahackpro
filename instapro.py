...
os.system("toilet -f future Mr.HaCkEr | lolcat")

os.system("toilet -f future [>] loding- | lolcat")

os.system("toilet -f future [>] loding-- | lolcat")

os.system("toilet -f future [>] loding--- | lolcat")

os.system("toilet -f future [+] insta loded [+] | lolcat")

import sys
print "====================== "
os.system("toilet -f future InStApRo | lolcat")
print " creat by Mr.HaCkEr "
print "====================== "
